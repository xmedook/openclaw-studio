...
Flow:
1. `AgentCreateModal` captures starter kit + control level and optional customization input (`src/features/agents/components/AgentCreateModal.tsx`).
